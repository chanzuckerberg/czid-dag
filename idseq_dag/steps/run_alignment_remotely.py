...
class PipelineStepRunAlignmentRemotely(PipelineStep):
    ...
    def chunk_input(self, input_files, chunksize):
        ...
        for input_file in input_files:
            ...
            command.execute_with_retries(f"aws s3 sync --only-show-errors {self.chunks_result_dir_local}/ {self.chunks_result_dir_s3}/ --recursive --exclude '*' --include '{out_prefix_base}*'")
