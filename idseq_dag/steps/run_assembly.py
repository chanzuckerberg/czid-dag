...
from idseq_dag.util.m8 import load_cdhit_cluster_sizes, get_read_dcr, MIN_CONTIG_SIZE
    ...
    def generate_info_from_sam(bowtie_sam_file, read2contig, cdhitdup_cluster_sizes_path):
        ...
        with open(bowtie_sam_file, "r", encoding='utf-8') as samf:
            for line in samf:
                ...
                read = fields[0]
                contig = fields[2]
                contig_stats[contig] += get_read_dcr(cdhit_cluster_sizes, read)  # these are non-unique read counts now
